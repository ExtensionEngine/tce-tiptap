  ...
  var script = {
    ...
    mounted() {
      this.editor = new tiptap.Editor({
        content: this.content,
        extensions: [new tiptapExtensions.Blockquote(), new tiptapExtensions.Bold(), new tiptapExtensions.Code(), new tiptapExtensions.Italic(), new tiptapExtensions.Link(), new tiptapExtensions.HardBreak(), new tiptapExtensions.Heading({
          levels: [1, 2, 3]
